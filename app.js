...
const countHandler = document.getElementById('count-handler');
...
const showImages = (images) => {
  ...
  countHandler.classList.remove('d-none');
...
const createSlider = () => {
  ...
  let absoluteDuration = document.getElementById('duration').value;
  if (absoluteDuration < 1000) {
    absoluteDuration = 1000;
  }
  const duration = absoluteDuration || 1000;
...
enterKeyHandler(search, searchBtn);
